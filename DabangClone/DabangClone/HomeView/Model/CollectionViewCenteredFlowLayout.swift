...
//setup collectionView center Align
open class CollectionViewCenteredFlowLayout: UICollectionViewFlowLayout {
  //layoutAttributesForElements function override and return optional [UICollectionViewLayoutAttributes] type.
  open override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
    ...
    //ScrollDirection condition check
